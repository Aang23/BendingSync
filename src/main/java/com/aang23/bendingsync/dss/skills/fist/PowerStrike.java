package com.aang23.bendingsync.dss.skills.fist;
 ...
 *
 */
public class PowerStrike extends SkillActive
{
	...
	public boolean canUse(EntityPlayer player) {
		return super.canUse(player) && !isActive() && player.getHeldItemMainhand() == ItemStack.EMPTY;
	}
	...
	public void onUpdate(EntityPlayer player) {
		if (isCharging(player)) {
			if (isKeyPressed() && player.getHeldItemMainhand() == ItemStack.EMPTY) {
